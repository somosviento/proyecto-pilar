...
# -*- coding: utf-8 -*-
"""
Script de migración para producción - Proyecto Pilar
Actualiza la base de datos existente al nuevo esquema con períodos
"""
...
def migrate_production_database(db_path):
    """
    Migra la base de datos de producción al nuevo esquema
    """
    print("=" * 60)
    print("MIGRACIÓN DE BASE DE DATOS - PROYECTO PILAR (PRODUCCIÓN)")
    print("=" * 60)
    ...
    try:
        ...
        if 'periodos_json' not in col_names:
            ...
            print("   ℹ️  La columna 'periodos_json' ya existe")
...
if __name__ == '__main__':
    ...
    if not os.path.exists(db_path):
        ...
        print("\nUso: python migrate_production.py [ruta_a_base_de_datos]")
        print("Ejemplo: python migrate_production.py /var/www/proyecto-pilar/instance/formularios.db")
        sys.exit(1)
    ...
    if respuesta.lower() in ['s', 'si', 'yes', 'y']:
        success = migrate_production_database(db_path)
